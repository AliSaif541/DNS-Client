...
var DnsClient = /** @class */ (function () {
    ...
    DnsClient.prototype.start = function (sockets) {
    ...
    DnsClient.prototype.waitForPendingQueries = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.all(Array.from(this.pendingQueries.values()).map(function (entry) { return entry.promise; }))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_b) {
                try {
                    _loop_1 = function (name_1, type) {
                        ...
                        this_1.pendingQueries.set(randomNumber, { promise: promise, resolve: resolvePromise });
                        var packet = void 0;
                        switch (type) {
                            case "A":
                        ...
                        this_1.sockets.performDnsQuery(packet.toBuffer());
                    };
                    this_1 = this;
